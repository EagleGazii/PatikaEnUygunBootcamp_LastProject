 ...
 */
final class Version20220809195628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail ADD birthday DATETIME NOT NULL, DROP age');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail ADD age SMALLINT NOT NULL, DROP birthday');
